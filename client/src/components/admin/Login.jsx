...
const handleSubmit = async (e) => {
  ...
  return (
    <div className='flex items-center justify-center h-screen'>
      <div className='w-full max-w-sm p-6 max-md:m-6 border border-indigo-100 shadow-xl shadow-indigo-50 rounded-lg'>
        <div className='flex flex-col items-center justify-center'>
            ...
            <form onSubmit={handleSubmit} className='mt-6 w-full sm:max-w-md text-gray-600'>
               ...
               <button type='submit' className='w-full py-3 font-medium bg-indigo-700 text-white rounded cursor-pointer hover:bg-indigo-600 transition-all'>Login</button>
            </form>
        </div>
      </div>
    </div>
